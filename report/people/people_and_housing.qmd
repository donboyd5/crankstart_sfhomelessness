...
The figure below shows San Francisco

```{r}
#| label: pit-count-show
#| include: true
...
[^1]: Technically, the comparisons is to HUD-defined areas, known as Continuums of Care, that include these cities.
...
San Francisco tracks exists from homelessness through three main kinds of programs: Permanent Supportive Housing, Rapid rehousing, and Problem Solving.
